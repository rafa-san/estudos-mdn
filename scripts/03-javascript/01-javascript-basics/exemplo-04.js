...
/*
1) const myImage = document.querySelector('img');: Aqui, estamos selecionando a primeira imagem (tag <img>) que o navegador encontrar na página e a armazenando na variável myImage.
...
/*
1) const myButton = document.querySelector('button');: Estamos selecionando o primeiro botão (<button>) encontrado na página e armazenando-o na variável myButton.

2) const myHeading = document.querySelector('h1');: Estamos selecionando o primeiro cabeçalho (<h1>) encontrado na página e armazenando-o na variável myHeading.
